...
export default function LightBar() {
  ...
  const seasonalLineOptions: ChartOptions<"line"> = {
    ...
    plugins: {
      ...
      title: {
        display: true,
        text: "Seasonal Light Bar Usage (Line Chart)",
        font: { size: 16, weight: "bold" },
      },
      tooltip: {
        callbacks: {
    ...
    <div className="lightbar-container">
      ...
      <div className="main-content">
        <div className="chart-section">
          ...
          {/* Seasonal Bar Chart */}
          <div className="mb-10">
            <h2 className="text-2xl font-semibold mb-4 text-gray-900">Seasonal Usage</h2>
          ...
          {/* Seasonal Line Chart */}
          <div className="mb-10">
            <h2 className="text-2xl font-semibold mb-4 text-gray-900">Seasonal Usage (Line Chart)</h2>
            <div className="chart-card">
          ...
          <div className="mb-10">
            <h2 className="text-2xl font-semibold mb-4 text-gray-900">Time of Day Usage</h2>
            <div className="chart-card">
