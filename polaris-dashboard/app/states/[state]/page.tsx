...
export default function StatePage() {
    ...
    if (loading) {
        return (
            <div className="state-container">
                <Sidebar />
                <div className="loading">Loading {stateId} data...</div>
            </div>
        );
    }
    ...
    const chartOptions = {
        ...
        plugins: {
            ...
            title: {
                display: true,
                text: `Monthly Vehicle Usage in ${stateId.charAt(0).toUpperCase() + stateId.slice(1)}`,
            },
        },
    };
        ...
        <div className="state-container">
            ...
            <main className="main-content">
                <div className="state-header">
                    ...
                    <h1>{stateId.charAt(0).toUpperCase() + stateId.slice(1)} State Data</h1>
                </div>
